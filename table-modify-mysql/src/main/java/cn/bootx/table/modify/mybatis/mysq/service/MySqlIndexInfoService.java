...
import cn.bootx.table.modify.mybatis.mysq.annotation.DbMySqlIndexes;
import cn.bootx.table.modify.mybatis.mysq.constants.MySqlIndexType;
import cn.bootx.table.modify.mybatis.mysq.entity.MySqlEntityIndex;
import cn.bootx.table.modify.mybatis.mysq.entity.MySqlModifyMap;
import cn.bootx.table.modify.mybatis.mysq.entity.MySqlTableIndex;
...
public class MySqlIndexInfoService {
    ...
    public void getModifyIndex(Class<?> clas, MySqlModifyMap baseTableMap){
        ...
        // 查询当前表中全部索引
        List<MySqlTableIndex> tableIndexes = mySqlTableModifyDao.findIndexByTableName(tableName);
