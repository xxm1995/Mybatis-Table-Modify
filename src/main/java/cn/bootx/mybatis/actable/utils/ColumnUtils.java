package cn.bootx.mybatis.actable.utils;

import cn.bootx.mybatis.actable.annotation.Column;
import cn.bootx.mybatis.actable.annotation.EnableTimeSuffix;
import cn.bootx.mybatis.actable.annotation.IsNativeDefValue;
import cn.bootx.mybatis.actable.annotation.Table;
import cn.bootx.mybatis.actable.annotation.impl.ColumnImpl;
import cn.bootx.mybatis.actable.impl.mysql.constants.MySql4JavaType;
...
public class ColumnUtils {
    ...
    public static MySqlTypeAndLength getMySqlTypeAndLength(Field field, Class<?> clazz) {
        ...
        // 类型为空根据字段类型去默认匹配类型
        MySqlFieldType mysqlType = MySql4JavaType.get(field.getGenericType().toString());
        if (mysqlType == null) {
